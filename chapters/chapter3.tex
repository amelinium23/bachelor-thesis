...
\begin{figure}[H]
    ...
    \label{database}
\end{figure}
Rysunek przedstawia struktury danych znajdujące się w projekcie aplikacji. Są one przesyłane za do użytkownika w formacie JSON |\ref{JSON}|. Omówmy znajdujące się na rysunku \ref{database} struktury danych:
\begin{enumerate}
